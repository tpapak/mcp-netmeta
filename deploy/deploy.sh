...
echo ""
echo "  NMA server:    https://biostatistics.med.auth.gr/mcp/netmeta/mcp"
echo "  Verify server: https://biostatistics.med.auth.gr/mcp/netmeta-verify/mcp"
echo ""
echo "Test NMA server:"
echo "  curl -X POST https://biostatistics.med.auth.gr/mcp/netmeta/mcp \\"
...
echo "  curl -X POST https://biostatistics.med.auth.gr/mcp/netmeta-verify/mcp \\"
echo "    -H 'Content-Type: application/json' \\"
echo "    -d '{\"jsonrpc\":\"2.0\",\"method\":\"initialize\",\"id\":1,\"params\":{\"protocolVersion\":\"2025-03-26\",\"capabilities\":{},\"clientInfo\":{\"name\":\"test\",\"version\":\"0.1.0\"}}}'"
